...
rsdController::rsdController(int argc,char* argv[]) {
    ...
    rtdReceiver = new RTDEReceiveInterface(ip);
}
...
void rsdController::pushAndPickEmptyBoxes()
{
   ...
   /* BOXES TOWARDS RIGHT
    ...
    newMoveJ({1.84128, -0.434111, 0.829026, -1.96683, -1.56905, 6.14592}, slow_vel, slow_acc);
    ...
    */
    ...
    newMoveJ({2.04685, -0.746991, 1.45881, -2.25322, -1.53475, 4.843}, slow_vel, slow_acc);

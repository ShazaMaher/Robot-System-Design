...
def printer():
    global print_flag, total_run_timer, total_exe_time
    print("Total run time is: "+str(total_run_timer)+" seconds")
    print("Total execution time is: "+str(total_exe_time)+" seconds")
    print_flag = True
